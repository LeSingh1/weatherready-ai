...
export const STATIC_CITIES: CityProfile[] = [
  city('fremon', 'Fremon', 'Generated City', 37.5485, -121.9886, 12, 'Simulated future suburb', 420000, 88000, 3.5,
    ...
    [
      { name: 'North Transit Disruption Zone', lat: 37.578, lng: -122.018, zone_type_id: 'BUS_STATION', category: 'Weather Risk', data_source: 'projected', w_deg: 0.018, h_deg: 0.012 },
      ...
      { name: 'South Emergency Gap', lat: 37.504, lng: -121.984, zone_type_id: 'HEALTH_CLINIC', category: 'Emergency Gap', data_source: 'projected', w_deg: 0.018, h_deg: 0.012 },
      { name: 'Cooling Center Gap', lat: 37.556, lng: -121.965, zone_type_id: 'PARK_SMALL', category: 'Heat Risk', data_source: 'projected', w_deg: 0.018, h_deg: 0.012 },
      { name: 'Smoke Shelter Access Gap', lat: 37.546, lng: -122.026, zone_type_id: 'BUS_STATION', category: 'Smoke Risk', data_source: 'projected', w_deg: 0.018, h_deg: 0.012 },
      { name: 'Innovation District', lat: 37.565, lng: -121.946, zone_type_id: 'COM_OFFICE_PLAZA', category: 'Heat Exposure', data_source: 'projected', w_deg: 0.016, h_deg: 0.011 },
      { name: 'New Housing Expansion Zone', lat: 37.516, lng: -121.942, zone_type_id: 'RES_MIXED_USE', category: 'Growth Pressure', data_source: 'projected', w_deg: 0.018, h_deg: 0.012 },
    ]
  ),
