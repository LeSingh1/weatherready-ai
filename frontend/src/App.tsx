...
const CITY_ANCHORS: Record<string, Array<[number, number]>> = {
  ...
  fremon: [
    [37.5780, -122.0180], [37.5480, -121.9360], [37.5040, -121.9840],
    [37.5560, -121.9650], [37.5460, -122.0260], [37.5650, -121.9460],
    [37.5160, -121.9420], [37.5710, -122.0100], [37.5300, -121.9650],
    [37.5600, -121.9320], [37.5400, -122.0150], [37.5200, -121.9800],
  ],
  // San Jose, CA
  san_jose: [
